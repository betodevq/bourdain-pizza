...
export class DatabaseInitialStructure1665113336485 implements MigrationInterface {
    name = 'DatabaseInitialStructure1665113336485'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`item\` (\`id\` int NOT NULL AUTO_INCREMENT, \`quantity\` int NOT NULL, \`orderId\` int NULL, \`pizzaId\` int NOT NULL, UNIQUE INDEX \`REL_5f487cf29e8cf4dfb6fb8518f6\` (\`pizzaId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`REL_5f487cf29e8cf4dfb6fb8518f6\` ON \`item\``);
